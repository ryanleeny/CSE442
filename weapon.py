...
weapon_frequency = [500, 1000, 60]  #set how fast the bullet come out of the player in ms

#initialzation of bullets
class Weapon(pygame.sprite.Sprite):
    animate = 1   # begining index of the array
    path = [0,animate**4]  #not use
    weapon_choice = 1   # which weapon are choosen, index of the weapons array
    ...
    animation_speed = [3, 15,1] # how much pixls the bullets move up every refresh, here the bigger negative the faster bullets move
